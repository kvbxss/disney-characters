...
const Search: FunctionComponent = () => {
  ...
  return (
    <SearchContainer>
      <ImageWrapper>
        <Image
          src="https://images.unsplash.com/photo-1556950961-8c092986258e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=764&q=80"
          alt="Disneyland"
        />
      </ImageWrapper>
      <SearchText>
        ...
        <Title>
          The Best Animated Disney Characters <br /> of All Time
        </Title>
        <SearchBar
